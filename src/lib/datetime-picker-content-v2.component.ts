...
@Component({
  selector: 'mat-datetime-picker-content-v2',
  template: `
    <div
      class="mat-datetime-picker-content"
      ...
      <div class="mat-datetime-picker-actions">
        <button
          mat-button
          type="button"
          class="mat-datetime-picker-cancel-button"
          (click)="onCancel()">
          Cancelar
        </button>
        <button
          mat-button
          type="button"
          class="mat-datetime-picker-apply-button"
          [color]="data.color"
          (click)="onApply()">
          Aplicar
        </button>
