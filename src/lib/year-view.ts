 ...
 */
@Component({
  selector: 'ad-mat-year-view',
  templateUrl: 'year-view.html',
  exportAs: 'adMatYearView',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [AdMatCalendarBody],
})
export class AdMatYearView<D> implements AfterContentInit, OnDestroy {
  ...
  _monthSelected(event: AdMatCalendarUserEvent<number>) {
  ...
  private _setSelectedMonth(value: AdDateRange<D> | D | null) {
    if (value instanceof AdDateRange) {
      this._selectedMonth =
